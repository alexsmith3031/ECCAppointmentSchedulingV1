...
class InsurancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create insurance" do
    assert_difference('Insurance.count') do
      post insurances_url, params: { insurance: { claim_number: @insurance.claim_number, ins_name: @insurance.ins_name, provide_number: @insurance.provide_number } }
    end
  ...
  test "should update insurance" do
    patch insurance_url(@insurance), params: { insurance: { claim_number: @insurance.claim_number, ins_name: @insurance.ins_name, provide_number: @insurance.provide_number } }
